...
- **[NotFair](https://github.com/nowork-studio/NotFair)** - Open-source Claude Code skills for SEO, Google Ads, and Meta Ads; connects to live account data through Google Ads MCP, Meta Ads MCP, Google Search Console MCP, and Google Analytics (GA4) MCP. #opensource
